    ...
    try {
        ...
        public void populate() throws Exception{
            ...
            l = new Livre("Le tour de monde en 80 jours",10, LocalDate.of(1885,6,1),1.50,"français","aventure","a126",350, TypeLivre.ROMAN,"voyage autour du monde");
            om.add(l);
            am.getAll().get(0).addOuvrage(l);
            ...
            e = new Exemplaire("m13","état neuf",om.getAll().get(0));
            em.add(e);
            rm.getAll().get(2).addExemplaire(e);

            e = new Exemplaire("t56","état neuf",om.getAll().get(2));
            em.add(e);
            rm.getAll().get(3).addExemplaire(e);

            e = new Exemplaire("t57","état usagé",om.getAll().get(3));
            em.add(e);
            rm.getAll().get(2).addExemplaire(e);

            Location loc = new Location(LocalDate.of(2023,2,1),LocalDate.of(2023,3,1),lm.getAll().get(0),em.getAll().get(0));
            locm.add(loc);
            ((Speciallocation)locm).enregistrerRetour(loc);

            loc = new Location(LocalDate.of(2023,2,5),LocalDate.of(2023,3,20),lm.getAll().get(1),em.getAll().get(1));
            locm.add(loc);
            ((Speciallocation)locm).enregistrerRetour(loc);

            loc = new Location(LocalDate.of(2023,2,5),null,lm.getAll().get(0),em.getAll().get(2));
            locm.add(loc);

            loc = new Location(LocalDate.of(2023,3,21),LocalDate.of(2023,3,27),lm.getAll().get(0),em.getAll().get(1));
            locm.add(loc);
            ((Speciallocation)locm).enregistrerRetour(loc);

            loc = new Location(LocalDate.of(2023,5,28),null,lm.getAll().get(2),em.getAll().get(3));
            locm.add(loc);

            loc = new Location(LocalDate.of(2023,5,1),LocalDate.of(2023,5,3),lm.getAll().get(0),em.getAll().get(4));
            locm.add(loc);
            ((Speciallocation)locm).enregistrerRetour(loc);

            loc = new Location(LocalDate.of(2023,5,29),null,lm.getAll().get(2),em.getAll().get(4));
            locm.add(loc);
        }
